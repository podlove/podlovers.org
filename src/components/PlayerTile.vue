<template>
  <div class="flex">
    <div class="player-tile-button w-20 h-20 mr-4 relative flex-shrink-0 mt-1">
      <g-image v-if="episode.poster" :src="require(`!!assets-loader?width=100&height=100!@images/${episode.poster}`)" class="rounded w-20 h-20 border border-podlove-blue-900" />
